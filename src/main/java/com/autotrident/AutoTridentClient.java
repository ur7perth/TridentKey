...
public class AutoTridentClient implements ClientModInitializer {
    ...
    /**
     * عدد التكات قبل الرمي. الحد الأدنى في اللعبة 10، لكن السيرفر يتأخر عنك
     * تكة أو تكتين، فنستخدم 12. لو ما زال ما يرمي جرّب 13 أو 14،
     * ولو تبيه أسرع جرّب 11.
     */
    private static final int THROW_TICKS = 12;
    ...
    public void onInitializeClient() {
        ...
        // بديل لفتح القائمة: الأمر /tridentkey
        ClientCommandRegistrationCallback.EVENT.register((dispatcher, registryAccess) ->
                dispatcher.register(ClientCommandManager.literal("tridentkey").executes(ctx -> {
